...
export const base_url = "https://trustlife.mytrustlab.co.in/";
export const paypal_url = "Enter_your_admin_link_here/";
export const api_url = "https://trustlife.mytrustlab.co.in/api/";
export const img_url = "https://trustlife.mytrustlab.co.in/public/uploads/";
export const app_name = "TrustLife";
...
// Home Screen Url
export const secondBaseUrl = 'https://mytrustlab.com/api';
export const BaseUrl = 'https://dos.mytrustlab.com/public/api/get-edos/';
...
export const payment_status_update = "customer/update_order_details";
...
export const customer_lab_completed_orders = "customer/lab/get_completed_orders";
...
//Path
export const thyroid_gland = require(".././assets/img/thyroid_gland.png");
export const testTube = require(".././assets/img/TestTube.png");
export const testTubeLab = require(".././assets/img/TestTubeLab.png");
...
export const logo_with_name = require(".././assets/img/splashLogo.png");
export const heartGif = require(".././assets/img/heartlogo.gif");
export const bike = require(".././assets/img/Blood_sample.png");
export const fast = require(".././assets/img/fast.png");
export const nodata = require(".././assets/img/nodata.png");
...
export const graph = require(".././assets/img/graph.png");
export const loginIcon = require(".././assets/img/loginIcon.png");
export const docIcon = require(".././assets/img/docIcon.png");
export const progress = require(".././assets/img/progress.png");
export const text = require(".././assets/img/text.png");
...
export const prescription = require(".././assets/img/prescriptioncard.png");
export const noprescription = require(".././assets/img/noprescription.png");
export const agent = require(".././assets/img/agent.png");
...
export const slides = [
    {
        ...
        main: '',
        image: doctor,
        title: 'Choose your Perfect Test',
