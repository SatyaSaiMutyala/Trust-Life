...
const PharmProducts = (props) => {
  ...
  const renderItem = ({ item }) => (
    ...
    > 
      <View style={{ padding:10,margin:8, borderRadius:10, backgroundColor:colors.theme_fg_three}}>  
      <TouchableOpacity activeOpacity={1} onPress={navigate_product_details.bind(this, item)}  style={{ alignItems:'center', justifyContent:'center' }}>  
        ...
        <View style={{ margin:5 }} />
        <Text numberOfLines={1} style={{ fontSize:12, color:colors.theme_fg_two, fontFamily:regular}}>{item.product_name} ({item.unit})</Text>
        <View style={{ margin:5 }} />
