        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                ...
                <View style={styles.card}>
                    ...
                    {/* Tests Count */}
                    <Text style={styles.testsCount}>20 Tests Added</Text>

                    {/* View Details Button */}
                    <TouchableOpacity
                        style={styles.viewDetailsBtn}
                        activeOpacity={0.7}
                        onPress={() => navigation.navigate('ViewLabTestDetailScreen')}
                    >
...
export default ViewLabTestsScreen;
