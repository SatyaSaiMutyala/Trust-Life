...
const HospitalDetails = (props) => {
        ...
        return data.our_vendors.map((data) => {
            return (
                ...
                >
                    ...
                    <TouchableOpacity activeOpacity={1} onPress={navigate_vendors.bind(this, data.id, data.store_name)} style={{ alignItems: 'center', borderRadius: 10, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.theme_fg_three }}>
    ...
    const show_labs = () => {
        return data.our_labs.map((data) => {
            return (
                <TouchableOpacity activeOpacity={1} onPress={navigate_lab_details.bind(this, data.id, data.lab_name)}>
                    <DropShadow
                        style={{
                            shadowColor: "#000",
                            shadowOffset: {
