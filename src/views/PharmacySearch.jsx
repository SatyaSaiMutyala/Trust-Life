...
const PharmacySearch = () => {
    ...
    const recommended_pharmacies = ({ item }) => (
        ...
        <SafeAreaView style={styles.container}>
          <StatusBar />
            ...
            {recommended_data.length > 0 &&
              <View>
                <Text style={{ paddingLeft:20, fontFamily:bold, color:colors.theme_fg_two, fontSize:14 }}>Recommended Pharmacies</Text>
                <View style={{ margin:3 }} />
                <FlatList
                  data={recommended_data}
                  renderItem={recommended_pharmacies}
            ...
            {data.length > 0 &&
              <ScrollView>
                <Text style={{ paddingLeft:20, fontFamily:bold, color:colors.theme_fg_two, fontSize:14 }}>Nearest Pharmacies</Text>
                <View style={{ margin:3 }} />
                <FlatList
                  data={data}
            ...
            {recommended_data.length == 0 && data.length == 0 &&
              <View style={{ flexDirection:'row', alignItems:'center', justifyContent:"center", marginTop:'50%' }}>
                <Text style={{ fontFamily:regular, fontSize:16, color:colors.theme_fg_two }}>No pharmacies available right now</Text>
              </View>
            }
