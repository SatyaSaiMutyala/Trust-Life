...
const HospitalConsultation = () => {
    const navigation = useNavigation();
    const route = useRoute();
    const flow = route.params?.flow;
    const [profilePic, setProfilePic] = useState(null);
    const [bottomTab, setBottomTab] = useState('hospitals');
        ...
        <SafeAreaView style={styles.container}>
            ...
            {!flow && (
                <StandaloneBottomBar
                    ...
                    tab2Label="Hospitals"
                    tab2Icon="hospital-building"
                    tab2IconType={Icons.MaterialCommunityIcons}
                />
            )}
        </SafeAreaView>
    );
...
export default HospitalConsultation;
