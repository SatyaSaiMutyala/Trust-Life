    ...
    <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity activeOpacity={1} onPress={navigate_lab_details.bind(this, row.id, row.lab_name)} style={{ width:150, margin:10}}>
             <DropShadow
              ...
              <View style={styles.list_container}>
                ...
                <View style={{ flexDirection:'row', padding:10, backgroundColor:colors.theme_fg_three,borderRadius:10}}>
      ...
      <View style={{ flexDirection:'row', margin:10, borderWidth:1, borderColor:colors.light_blue, padding:20, borderRadius:10, backgroundColor:colors.light_blue }}>
        ...
        <View style={{ width:'40%', alignItems:'flex-end'}}>
          <TouchableOpacity onPress={call_admin.bind(this, global.admin_contact_number)} style={{ borderColor:colors.theme_fg, borderWidth:1, borderRadius:10, padding:10, alignItems:'center', justifyContent:'center' }}>
      ...
      {nearest.map((row, index) => (
        <TouchableOpacity activeOpacity={1} onPress={navigate_lab_details.bind(this, row.id, row.lab_name)} style={{ padding:10, borderRadius:10, backgroundColor:colors.theme_fg_three }}>
           <DropShadow
                style={{
                  shadowColor: "#000",
                  elevation:5,
            ...
            <View style={styles.list_container}>
              <Image
                ...
                source={{ uri: img_url+row.lab_image }}
              />
              <View style={{ flexDirection:'row', padding:20, backgroundColor:colors.theme_fg_three,borderRadius:10}}>
                <View style={{ width:'100%', alignItems:'flex-start', justifyContent:'center'}}>
