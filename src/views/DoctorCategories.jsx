  ...
  <SafeAreaView style={styles.container}>
    ...
    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', paddingLeft:10, paddingRight:10, paddingTop:10 }}>
      <FlatList 
        ...
        numColumns={3}
        renderItem={({ item }) => (
          <TouchableOpacity onPress={navigate.bind(this,item.id)} style={{ backgroundColor:colors.theme_bg_three, borderRadius:10, width:'35%', alignItems:'center', justifyContent:'center', maxWidth: Dimensions.get('window').width /2, flex:0.5, marginBottom: 10, margin:5 }}>
            <View style={{ width:'100%', height:100 }}>
