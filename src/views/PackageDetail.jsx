...
const PackageDetail = (props) => {
  ...
  const add_to_cart = async (item_id,item_name,price) => {
    ...
    console.log(package_details.id,package_details.package_name,package_details.price,package_details.lab_id);
...
return (
  <SafeAreaView style={styles.container}>
      ...
      <View style={{ padding:10, backgroundColor:colors.theme_bg_three }}>
        ...
        {props.cart_items[package_id] == undefined ?
          <LinearGradient colors={[ colors.theme_color,colors.theme_color_One, ]} style={ styles.button2 }>
            <TouchableOpacity onPress={add_to_cart.bind(this,package_details.id,package_details.package_name,package_details.price,package_details.lab_id)} >
              <Text style={{ fontSize:14, fontFamily:bold, color:'#fff'}}>Add to Cart</Text>
            </TouchableOpacity>
          </LinearGradient>
          :
          <LinearGradient colors={[ colors.theme_color,colors.theme_color_One, ]} style={ styles.button2 }>
            ...
            <TouchableOpacity onPress={add_to_cart.bind(this,package_details.id,package_details.package_name,package_details.price,package_details.lab_id)} >
              <Text style={{ fontSize:14, fontFamily:bold, color:'#fff'}}>Remove</Text>
            </TouchableOpacity>
      ...
      <View style={{ padding:10, backgroundColor:colors.theme_bg_three }}>
        ...
        <View style={{ width:'100%', flexDirection:'row'}}>
          ...
          <View style={{ width:'30%', alignItems:'flex-end', justifyContent:'center' }}>
            <LinearGradient colors={[ colors.theme_color,colors.theme_color_One, ]} style={ styles.button2 }>
              <TouchableOpacity onPress={call_admin.bind(this, global.admin_phone_number)}>
                <Text style={{ fontSize:14, color:'#fff', fontFamily:regular}}>Call us now</Text>
              </TouchableOpacity> 
            </LinearGradient>
          </View>
        </View>
    ...
    {props.cart_items[package_id] != undefined &&
        ...
        <View style={{ position:'absolute', bottom:0, height:60, padding:10, width:'100%', marginBottom: 10}}>
          <View style={{ width:'100%', flexDirection:'row'}}>
          <LinearGradient colors={[ colors.theme_color,colors.theme_color_One, ]} style={ styles.button2 }>
            ...
            style={{
              ...
              <Text style={{ fontSize:14, color: "#fff", fontFamily:bold}}>Move to cart</Text>
            </TouchableOpacity>
          </LinearGradient>
          </View>
        </View>
