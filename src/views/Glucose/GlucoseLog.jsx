        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.imageContainer}>
                    <Image
                        source={require('../../assets/img/glucoseimg.png')}
                        style={styles.image}
                    />
                </View>

                {/* Title */}
                <Text style={styles.title}>Track Your Glucose Levels</Text>

                {/* Description */}
                <Text style={styles.description}>
                    Log or sync your blood sugar readings to monitor your health.
                </Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
                <PrimaryButton
                    title="Continue"
                    onPress={() => navigation.navigate('GlucoseDashboard')}
