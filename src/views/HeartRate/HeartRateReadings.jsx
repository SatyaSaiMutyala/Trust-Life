...
const HeartRateReadings = () => {
    ...
    const allReadings = route?.params?.readings || [
        ...
        { id: '5', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25 },
        { id: '6', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25 },
        { id: '7', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25 },
        { id: '8', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25 },
    ];
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Heart Rate  Readings</Text>
