    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.title}>Track Your Menstrual Cycle</Text>

                <Text style={styles.description}>
                    Log your cycle and symptoms to track your menstrual health.
                </Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
                <PrimaryButton
                    title="Continue"
                    onPress={() => navigation.navigate('MenstrualCycleDashboard')}
...
export default MenstrualCycleLog;
