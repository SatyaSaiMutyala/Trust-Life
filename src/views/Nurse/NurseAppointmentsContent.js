...
const MOCK_NURSE_APPOINTMENTS = [
    {
        id: '1',
        status: 'Confirmed',
        date: '17 Feb 2026, 08:00',
        doctorName: 'Suresh Varma',
        rating: 4.5,
        specialty: 'Pediatric Nurse',
        address: 'CareHome Services, Banjara Hills, Hyderabad...',
        amountPaid: '₹500',
        appointmentId: '#NR8326453845',
        appointmentDateTime: '08:00, Mon, 17 Feb, 2026',
        consultationType: 'Home Visit',
        consultationAddress: 'CareHome Services, Road No. 10, Banjara Hills, Hyderabad - 500034',
        paymentVia: 'Google Pay',
        transactionId: '9673853609901',
    },
    {
        id: '2',
        status: 'Completed',
        ...
        rating: 4.7,
        specialty: 'ICU Nurse',
        address: 'Apollo Hospital, Jubilee Hills, Hydera...',
        amountPaid: '₹450',
        appointmentId: '#NR8326453846',
        appointmentDateTime: '09:00, Tue, 10 Feb, 2026',
        consultationType: 'In-Person',
        consultationAddress: 'Apollo Hospital, Jubilee Hills, Hyderabad - 500033',
        paymentVia: 'Phone Pay',
        transactionId: '9673853609902',
    },
    {
        id: '3',
        status: 'Cancelled',
        date: '05 Feb 2026, 07:30',
        doctorName: 'Suma',
        rating: 4.3,
        specialty: 'Oncology Nurse',
        address: '',
        amountPaid: '₹400',
        appointmentId: '#NR8326453847',
        appointmentDateTime: '07:30, Thu, 05 Feb, 2026',
        consultationType: 'Home Visit',
        consultationAddress: 'Home Visit, Madhapur, Hyderabad - 500081',
        paymentVia: 'UPI',
        transactionId: '9673853609903',
    },
];
...
const AppointmentCard = ({ item }) => {
    ...
    const handleViewDetails = () => {
        navigation.navigate('NurseAppointmentDetail', { appointment: item });
    };
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.nurseRow}>
                <Text style={styles.nurseName}>{item.doctorName}</Text>
            ...
            {!!item.address && (
                <View style={styles.addressSection}>
                    <Text style={styles.addressLabel}>Visit Address</Text>
...
const NurseAppointmentsContent = () => {
    const [activeTab, setActiveTab] = useState('All');

    const filtered = MOCK_NURSE_APPOINTMENTS.filter((a) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Nurse Sessions</Text>
            </View>
...
export default NurseAppointmentsContent;
...
const styles = StyleSheet.create({
    ...
    nurseRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: vs(2) },
