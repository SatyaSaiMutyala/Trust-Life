...
const MOCK_COUNSELLING_APPOINTMENTS = [
    {
        id: '1',
        status: 'Confirmed',
        date: '17 Feb 2026, 11:00',
        doctorName: 'Ramesh Kumar',
        rating: 4.5,
        specialty: 'Stress Counselling',
        address: 'MindCare Centre, Banjara Hills, Hyderabad...',
        amountPaid: '₹900',
        appointmentId: '#CN8326453845',
        appointmentDateTime: '11:00, Mon, 17 Feb, 2026',
        consultationType: 'In-Person',
        consultationAddress: 'MindCare Centre, Road No. 12, Banjara Hills, Hyderabad - 500034',
        paymentVia: 'Google Pay',
        transactionId: '9573853609801',
    },
    {
        id: '2',
        status: 'Completed',
        date: '10 Feb 2026, 10:00',
        doctorName: 'Rajesh Sharma',
        rating: 4.7,
        specialty: 'Anxiety Counselling',
        address: 'WellMind Studio, Jubilee Hills, Hydera...',
        amountPaid: '₹750',
        appointmentId: '#CN8326453846',
        appointmentDateTime: '10:00, Tue, 10 Feb, 2026',
        consultationType: 'Online',
        consultationAddress: 'Online Session via App',
        paymentVia: 'Phone Pay',
        transactionId: '9573853609802',
    },
    {
        id: '3',
        status: 'Cancelled',
        date: '05 Feb 2026, 09:30',
        doctorName: 'Anil Kumar',
        rating: 4.3,
        specialty: 'Relationship Counselling',
        address: '',
        amountPaid: '₹650',
        appointmentId: '#CN8326453847',
        appointmentDateTime: '09:30, Thu, 05 Feb, 2026',
        consultationType: 'In-Person',
        consultationAddress: 'HealSpace, Madhapur, Hyderabad - 500081',
        paymentVia: 'UPI',
        transactionId: '9573853609803',
    },
];
...
const AppointmentCard = ({ item }) => {
    ...
    const handleViewDetails = () => {
        navigation.navigate('CounsellingAppointmentDetail', { appointment: item });
    };
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.counsellorRow}>
                <Text style={styles.counsellorName}>{item.doctorName}</Text>
...
const CounsellingAppointmentsContent = () => {
    const [activeTab, setActiveTab] = useState('All');

    const filtered = MOCK_COUNSELLING_APPOINTMENTS.filter((a) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Counselling Sessions</Text>
            </View>
...
export default CounsellingAppointmentsContent;
