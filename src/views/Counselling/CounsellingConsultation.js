...
import CounsellingAppointmentsContent from './CounsellingAppointmentsContent';
...
const CounsellingConsultation = () => {
    ...
    const renderCard = ({ item, index }) => (
        <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => navigation.navigate('CounsellingSpecialistList', { specialtyName: item.name, flow: flow || 'counselling' })}
        >
            ...
            {bottomTab === 'doctors' ? (
                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.searchPlaceholder}>Search for Specialized counseller</Text>
                ...
                <CounsellingAppointmentsContent />
            )}

            <StandaloneBottomBar
                activeTab={bottomTab}
                onTabChange={setBottomTab}
                tab2Label="Counselling"
                tab2Icon="psychology"
                tab2IconType={Icons.MaterialIcons}
                tab2Screen="CounsellingScreen"
            />
        </SafeAreaView>
    );
};

export default CounsellingConsultation;
