        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                <View style={styles.imageContainer}>
                    <Image
                        source={require('../../assets/img/bodyTemprature.png')}
                        style={styles.image}
                    />
                </View>

                <Text style={styles.title}>Track Your Body Temperature</Text>

                <Text style={styles.description}>
                    Log your temperature readings to monitor changes and stay informed about your health.
                </Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
                <PrimaryButton
                    title="Continue"
                    onPress={() => navigation.navigate('TemperatureDashboard')}
