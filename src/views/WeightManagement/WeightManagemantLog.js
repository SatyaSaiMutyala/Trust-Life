    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                {/* Title */}
                <Text style={styles.titleBold}>Track Your Weight</Text>

                {/* Description */}
                <Text style={styles.description}>
                   Monitor your weight regularly to see progress, understand trends, and stay focused on your health goals.
                </Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
                <PrimaryButton
                    title="Continue"
                    onPress={() => navigation.navigate('WeightManagementDashboard')}
...
export default WeightManagementLog;
