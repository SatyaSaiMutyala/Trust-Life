...
const WeightManagementDashboard = () => {
    ...
    const readings = [
        { id: '1', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25, status: 'with empty stomach' },
        { id: '2', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25, status: 'morning' },
        { id: '3', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25, status: 'morning' },
        { id: '4', date: 'Mon, 11 Feb,2026,12:30 PM', bpm: 25, status: 'with empty stomach' },
    ];
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    ...
                    <View style={styles.headerCenter}>
                        <Text style={styles.headerTitle}>WeightManagement </Text>
                    </View>
                    <View style={styles.headerRight}>
                        <TouchableOpacity style={styles.headerIconBg} onPress={() => navigation.navigate('AddWeightManagemant')}>
                ...
                {hasData ? (
                    ...
                    <View style={styles.recentSection}>
                        <View style={styles.recentHeader}>
                            ...
                            <TouchableOpacity onPress={() => navigation.navigate('WeightManagementReadings', { readings })}>
