...
const AddWeightManagemant = () => {
    ...
    const handleSave = () => {
        navigation.navigate('SuccessScreen', {
            ...
            delay: 2000,
            targetScreen: 'WeightManagementDashboard',
            useNavigate: true,
        });
    };
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle}>Adding Weight Management</Text>
...
export default AddWeightManagemant;
