...
const MedicalBills = () => {
    ...
    const [bills] = useState(GROUPED_BILLS);
    ...
    const renderEmptyState = () => (
        <View style={styles.emptyContainer}>
            <Image
                ...
                resizeMode="contain"
            />
            <Text style={styles.emptyTitle}>No Medical Bills Yet</Text>
            <Text style={styles.emptyDesc}>
                Upload your medical bills to keep them{'\n'}organized and easy to access.
            </Text>
            <TouchableOpacity
                style={styles.addBillsBtn}
                activeOpacity={0.7}
                onPress={() => navigation.navigate('UploadMedicalBill')}
            >
                <Icon type={Icons.Feather} name="plus" color={whiteColor} size={ms(18)} />
                <Text style={styles.addBillsBtnText}>Upload Medical Bills</Text>
            </TouchableOpacity>
        </View>
    );
    ...
    const renderBillsList = () => {
        if (!hasBills) return renderEmptyState();
                ...
                <FlatList
                    ...
                    renderItem={({ item: group }) => (
                        <View style={styles.dateGroup}>
                            ...
                            {group.records.map((record) => renderBillItem(record))}
                        </View>
                    )}
                />
                {/* Floating Add Button */}
