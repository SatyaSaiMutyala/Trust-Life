...
const MOCK_COACHES = [
    { id: '1', name: 'Ramesh Kumar',  rating: 4.5, reviews: '86k', online: true,  image: require('../../assets/img/gym-one.png')   },
    { id: '2', name: 'Rajesh Sharma', rating: 4.5, reviews: '86k', online: false, image: require('../../assets/img/gym-two.png')   },
    { id: '3', name: 'Anil Kumar',    rating: 4.5, reviews: '86k', online: false, image: require('../../assets/img/gym-three.png') },
    { id: '4', name: 'Susheel Varma', rating: 4.5, reviews: '86k', online: true,  image: require('../../assets/img/gym-one.png')   },
    { id: '5', name: 'Rahul Kumar',   rating: 4.5, reviews: '86k', online: false, image: require('../../assets/img/gym-two.png')   },
    { id: '6', name: 'Ramesh Kumar',  rating: 4.5, reviews: '86k', online: true,  image: require('../../assets/img/gym-three.png') },
    { id: '7', name: 'Anil Sharma',   rating: 4.5, reviews: '86k', online: false, image: require('../../assets/img/gym-one.png')   },
    { id: '8', name: 'Ramesh Kumar',  rating: 4.5, reviews: '86k', online: false, image: require('../../assets/img/gym-two.png')   },
];

const FILTERS = ['Experience', 'Consultation Type'];

const CoachCard = ({ item, index, onPress }) => (
    <TouchableOpacity
        style={[
            styles.card,
...
const CoachSpecialistList = () => {
    const navigation = useNavigation();
    const route = useRoute();
    const coachType = route.params?.specialtyName || 'Coaches';
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                <View style={styles.header}>
                    ...
                    <Text style={styles.headerTitle} numberOfLines={1}>{coachType}</Text>
                </View>
                ...
                <View style={styles.searchBar}>
                    ...
                    <TextInput
                        ...
                        placeholder="Search for Specialized coaches"
                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        <CoachCard
                            item={item}
                            index={index}
                            onPress={() => navigation.navigate('CoachProfileScreen', { doctor: item, flow })}
                        />
                    )}
...
export default CoachSpecialistList;
