...
const CoachProfileScreen = () => {
    ...
    const coach = route.params?.doctor || {};
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            >
                ...
                {/* Coach info + avatar row */}
                <View style={styles.headerBody}>
                    {/* Left: info */}
                    <View style={styles.infoBlock}>
                        <Text style={styles.coachName}>{coach.name || 'Ramesh Kumar'}</Text>
                        <Text style={styles.coachId}>ID:584684745</Text>
                        <View style={styles.specialtyBadge}>
                            <Text style={styles.specialtyBadgeText}>
                                {coach.specialty || 'Certified Coach'}
                            </Text>
                        </View>
                        <View style={styles.ratingRow}>
                            <Icon type={Icons.MaterialIcons} name="star" size={ms(15)} color="#FFC107" />
                            <Text style={styles.ratingVal}>{coach.rating || '4.5'}</Text>
                            <Text style={styles.reviewsText}>  {coach.reviews || '86k'} Reviews</Text>
                        </View>
                    </View>
                ...
                <PrimaryButton
                    ...
                    onPress={() => {
                        ...
                        navigation.navigate('ReviewAppointmentScreen', {
                            doctor: { ...coach, specialty: coach.specialty || 'Certified Coach' },
