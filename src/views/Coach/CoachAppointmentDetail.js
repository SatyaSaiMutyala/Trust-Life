...
const CoachMini = ({ name, specialty, rating }) => (
    <View>
        ...
        <Text style={styles.coachSpecialty}>{specialty}</Text>
    </View>
);
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                ...
                {isCompleted && (
                    <View style={styles.completedHeader}>
                        ...
                        <Text style={styles.completedMessage}>
                            Thanks for your session! Your coaching session has been successfully completed.
                        </Text>
                ...
                <SectionCard title="Coach Details">
                    <CoachMini
...
export default CoachAppointmentDetail;
