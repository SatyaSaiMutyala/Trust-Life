...
const ChronicProgressiveScreen = () => {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTextWrap}>
                    <Text style={styles.headerTitle}>Chronic Progressive</Text>
            ...
            >
                {CONDITIONS_DATA.map((item) => (
                    <ConditionCard
                        key={item.id}
                        item={item}
                        onPress={() => navigation.navigate('ChronicProgressiveDetailScreen', { condition: item })}
                    />
                ))}
            </ScrollView>
        </SafeAreaView>
...
export default ChronicProgressiveScreen;
