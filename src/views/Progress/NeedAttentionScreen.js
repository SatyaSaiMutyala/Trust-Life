        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTextWrap}>
                    <Text style={styles.headerTitle}>Need Attention</Text>
                    <Text style={styles.headerSubtitle}>My vital organs Monitoring</Text>
                </View>
            </View>
            ...
            >
                {CONDITIONS_DATA.map((item) => (
                    <ConditionCard
                        key={item.id}
                        item={item}
                        onPress={() => navigation.navigate('NeedAttentionDetailScreen', { condition: item })}
                    />
                ))}
            </ScrollView>
        </SafeAreaView>
...
export default NeedAttentionScreen;
