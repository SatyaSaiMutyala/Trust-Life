...
const styles = StyleSheet.create({
    ...
    impactDetailName: { fontFamily: bold, fontSize: ms(13), flex: 1 },
    impactDetailBadge: { borderRadius: ms(8), paddingHorizontal: ms(8), paddingVertical: vs(3) },
    impactDetailBadgeText: { fontFamily: bold, fontSize: ms(9) },
    ...
    impactDetailBoxTitle: { fontFamily: bold, fontSize: ms(10) },
    impactDetailBoxText: { fontFamily: regular, fontSize: ms(11), color: '#374151', lineHeight: ms(17) },
    ...
    bmActivity: { fontFamily: regular, fontSize: ms(10), color: '#9CA3AF', marginTop: vs(1) },
