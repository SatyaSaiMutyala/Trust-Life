...
const MOCK_PHYSIO_APPOINTMENTS = [
    {
        id: '1',
        status: 'Confirmed',
        date: '17 Feb 2026, 09:00',
        doctorName: 'Ramesh Kumar',
        rating: 4.5,
        specialty: 'Sports Physiotherapy',
        address: 'PhysioPlus Clinic, Kondapur, Hyderabad...',
        amountPaid: '₹800',
        appointmentId: '#PH8326453845',
        appointmentDateTime: '09:00, Mon, 17 Feb, 2026',
        consultationType: 'In-Person',
        consultationAddress: 'PhysioPlus Clinic, Plot 45, Kondapur, Hyderabad - 500084',
        paymentVia: 'Google Pay',
        transactionId: '9773853610001',
    },
    {
        id: '2',
        status: 'Completed',
        date: '10 Feb 2026, 10:30',
        doctorName: 'Rajesh Sharma',
        rating: 4.7,
        specialty: 'Orthopedic Therapy',
        address: 'RehabCare, Jubilee Hills, Hydera...',
        amountPaid: '₹700',
        appointmentId: '#PH8326453846',
        appointmentDateTime: '10:30, Tue, 10 Feb, 2026',
        consultationType: 'In-Person',
        consultationAddress: 'RehabCare, Road No. 36, Jubilee Hills, Hyderabad - 500033',
        paymentVia: 'Phone Pay',
        transactionId: '9773853610002',
    },
    {
        id: '3',
        status: 'Cancelled',
        date: '05 Feb 2026, 08:00',
        doctorName: 'Anil Kumar',
        rating: 4.3,
        specialty: 'Neurological Therapy',
        address: '',
        amountPaid: '₹650',
        appointmentId: '#PH8326453847',
        appointmentDateTime: '08:00, Thu, 05 Feb, 2026',
        consultationType: 'Home Visit',
        consultationAddress: 'Home Visit, Madhapur, Hyderabad - 500081',
        paymentVia: 'UPI',
        transactionId: '9773853610003',
    },
];
...
const AppointmentCard = ({ item }) => {
    ...
    const handleViewDetails = () => {
        navigation.navigate('PhysiotherapyAppointmentDetail', { appointment: item });
    };
    ...
    return (
        <View style={styles.card}>
            ...
            <View style={styles.physioRow}>
                <Text style={styles.physioName}>{item.doctorName}</Text>
...
const PhysiotherapyAppointmentsContent = () => {
    const [activeTab, setActiveTab] = useState('All');

    const filtered = MOCK_PHYSIO_APPOINTMENTS.filter((a) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Physiotherapy Sessions</Text>
            </View>
...
export default PhysiotherapyAppointmentsContent;
